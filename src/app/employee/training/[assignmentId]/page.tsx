              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <div className="space-y-8">
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                    <h3 className="font-semibold text-gray-900 mb-2">⚙️ {t('configuration.sessionConfiguration')}</h3>
                    <div className="text-gray-700 text-sm space-y-1">
                      <p><strong>{t('configuration.trainingMode')}</strong>
                        {currentScenario.scenario_type === 'theory'
                          ? '📖 Theory Assessment'
                          : currentScenario.scenario_type === 'recommendations'
                          ? '🎯 Situationships'
                      ...
                      <div className="text-gray-600"><strong>{t('configuration.scenario')}</strong> <HiddenContent type="title" customPlaceholder="Mystery Scenario" showIcon={false} className="inline" /></div>
                      {currentScenario.session_time_limit_minutes && (
                        <p><strong>{t('configuration.timeLimit')}</strong> ⏱️ {currentScenario.session_time_limit_minutes} {t('configuration.minutes')}</p>
                      )}
                      <p><strong>{t('configuration.company')}</strong> {companyId}</p>
                    </div>
                  </div>
