    ...
    <div className="max-w-2xl mx-auto">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-gray-900">{isEditing ? t('editTrack') : t('createTrack')}</h3>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            >
              <option value="new_hire">{t('newHire')}</option>
              <option value="existing_employee">{t('experienced')}</option>
            </select>
          </div>
        </div>
          ...
          >
            {isSubmitting ? (
              ...
              <>
                ...
                <span>{isEditing ? t('updateButton') : t('createButton')}</span>
              </>
            )}
          </button>
        </div>
