        ...
        >
          <div className="flex items-center">
            ...
            <h3 className="text-lg font-semibold text-green-900">
              {t('feedbackSection.strengthsTitle')} ({strengths.length})
            </h3>
          </div>
          {strengthsExpanded ? (
          ...
          <div className="p-4 space-y-3">
            {strengths.length > 0 ? (
              ...
              <div className="text-center text-gray-500 py-4">
                {t('feedbackSection.noStrengthsIdentified')}
              </div>
            )}
          </div>
        )}
        ...
        >
          <div className="flex items-center">
            ...
            <h3 className="text-lg font-semibold text-yellow-900">
              {t('feedbackSection.improvementsTitle')} ({improvements.length})
            </h3>
          </div>
        ...
        {improvementsExpanded && (
          <div className="p-4 space-y-3">
            {improvements.length > 0 ? (
                  ...
                  {improvement.better && (
                    <div className="text-sm">
                      <div className="text-green-700 font-medium mb-1">
                        {t('feedbackSection.betterApproach')}
                      </div>
              ...
              <div className="text-center text-gray-500 py-4">
                {t('feedbackSection.noImprovementsNeeded')}
              </div>
            )}
          </div>
        )}
