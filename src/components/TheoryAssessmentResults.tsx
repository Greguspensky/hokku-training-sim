    ...
    return (
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex items-center mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-900">Assessment Error</h3>
        </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            No questions were matched from this theory session for assessment.
          </p>
        </div>
      </div>
    )
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <div className="ml-4 text-right">
                  ...
                  >
                    {expanded.has(result.questionId) ? 'Show Less' : 'Show Details'}
                  </button>
                </div>
              </div>
            </div>
